...
int main()
{
    ...
    ptr=(int*)malloc(isize*sizeof(int));    //4 byte chya patit memory de asa os sangto aapn (int * )mule runtime la allocate hoil malloc=memory allocation malloc chi return value void*(generic pointer)
...
//void*malloc(int size);   ->prototype
